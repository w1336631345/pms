...
public class RoleController extends BaseController<Role> {
	...
	@RequestMapping(path = "{id}/function", method = RequestMethod.PUT)
	public HttpResponse<Role> modifyFunction(@PathVariable("id") String id, @RequestBody String[] functions) {
		roleService.modifyFunction(id, functions);
