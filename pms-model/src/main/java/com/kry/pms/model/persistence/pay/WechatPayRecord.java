...
public class WechatPayRecord extends PersistenceModel {
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '调用接口提交的商户号'")
    private String mchId;//调用接口提交的商户号
    @Column(columnDefinition = "varchar(64) COMMENT '用户是否关注公众账号，仅在公众账号类型支付有效，取值范围：Y或N;Y-关注;N-未关注'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '银行类型'")
    private String bankType;//银行类型
    @Column(columnDefinition = "varchar(64) COMMENT '默认人民币：CNY 货币类型'")
    private String feeType;//默认人民币：CNY 货币类型
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '随机数'")
